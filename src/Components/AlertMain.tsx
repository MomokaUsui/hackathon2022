...
export const AlertMain = (props: {
  ...
  return (
    <>
      {props.isAlertOpen ? (
        <div>
          <div className="bg-yellow-400 dark:bg-gray-800">
            <div className="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between flex-wrap">
                <div className="w-0 flex-1 flex items-center">
                  <span className="flex p-2 rounded-lg bg-yellow-800 dark:bg-black">
                    <svg
                  ...
                  <p className="ml-3 font-medium text-black-400 truncate">
